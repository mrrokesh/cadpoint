...
import "./ElectricalAndElectronicsMasterDiplomaCourses.css";

import placeholderImage from "../ElectricalAndElectronicsImages/Electronics.jpg";


const allCourses = [
    { id: "master-mep-hvac", title: "Master Diploma in MEP & HVAC Design with Project Planning", category: "Master Diploma", softwares: ["AutoCAD 2D", "Revit MEP", "HVAC", "HAP", "Microsoft Project", "Primavera", "PPM Concepts"], duration: "380 hours", availability: "Online / Offline", description: "Master-level MEP + HVAC + project planning program.", image: placeholderImage, className: "master-mep-hvac-card" },
    { id: "master-electrical-system", title: "Master Diploma in Electrical Building System Design", category: "Master Diploma", softwares: ["AutoCAD Electrical", "Revit MEP", "ETAP", "Dialux", "Navisworks", "MS Project"], duration: "420 hours", availability: "Online / Offline", description: "Master electrical building system program.", image: placeholderImage, className: "master-electrical-system-card" },
    { id: "master-mep-bim", title: "Master Diploma in MEP Coordination with BIM", category: "Master Diploma", softwares: ["Revit MEP", "Navisworks", "AutoCAD 2D", "Microsoft Project", "Primavera", "PPM Concepts"], duration: "320 hours", availability: "Online / Offline", description: "Master MEP + BIM coordination program.", image: placeholderImage, className: "master-mep-bim-card" }
  ];
